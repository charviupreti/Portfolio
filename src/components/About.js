        ...
        <div className=" col-md-7 d-flex align-items-center justify-content-center">
          <div>
            ...
            <div className="contain">
              <p>
                Hello,
                <br /> I'm based in Delhi and I'm passionate about Data
                Analytics and AI-ML. I also have a keen interest in web
                development. I make it a priority to stay up-to-date with the
                latest technologies and trends in these fields to continuously
                improve my skills.
                <br /> In my spare time, I enjoy hand lettering, and I'm an
                active member of the VITeach club at VIT Chennai, a student-run
                social outreach club. <br />
